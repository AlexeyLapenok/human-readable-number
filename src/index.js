module.exports = function toReadable(number) {
    ...
    if (number >= 20 && number < 100) {
        ...
        word === arr[String(number)[0]] + ' hundred ' + 'zero' ? word = arr[String(number)[0]] + ' hundred' : '';
        ...
        word === arr[String(number)[0]] + ' hundred ' + wordDozens + ' ' + 'zero' ? word = arr[String(number)[0]] + ' hundred ' + wordDozens : '';
    }
